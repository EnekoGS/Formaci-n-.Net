"use strict";
const calcularIvaParametros = (importe, porcentaje) => {
    return (importe * porcentaje) / 100;
};
const iva = calcularIvaParametros(1000, 21);
console.log(iva);
const calcularIva2 = (importe, porcentaje) => {
    return (importe * (porcentaje || 21)) / 100;
};
const iva2 = calcularIva2(1000, 21);
...
//# sourceMappingURL=EjemploParametrosVarios.js.map