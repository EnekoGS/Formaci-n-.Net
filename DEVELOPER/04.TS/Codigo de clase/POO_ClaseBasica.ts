class ClaseSencilla {
    // Propiedades. En una clase, las propiedades suelen ser privadas. El modificador de acceso private hace de una propiedad algo privado que no se verá en el objeto cuando se instancie.
    ...
    // Métodos. El modificador de acceso public hace que los métodos sean accesibles desde el objeto. No hace falta ponerlo porque por defecto las propiedades y métodos son públicos
  ...
  // Creamos un objeto de la clase. El constructor es llamado por la palabra reservada new. Le pasamos los valores 5 y 3 que son los argumentos que necesita el constructor. Serán los valores que tomen las propiedades a y b respectivamente
