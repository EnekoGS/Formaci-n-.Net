...
import { IPerson } from 'src/app/interfaces/persona.interface';

@Component({
  selector: 'app-actividad-ng-for',
  templateUrl: './actividad-ng-for.component.html',
  styleUrls: ['./actividad-ng-for.component.css']
})
export class ActividadNgForComponent {
  personas: IPerson[]=[
    {
      nombre: 'Domeniga',
      apellido: 'Kenwin',
